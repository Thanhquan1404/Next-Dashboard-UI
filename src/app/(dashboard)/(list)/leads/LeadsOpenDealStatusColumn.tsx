...
const LeadsInOpenStatusSample = ({
  ...
  // STATE 
  const [isBeingDragged, setIsBeingDragged] = useState<boolean | null>(false);
...
export default LeadsInOpenStatusSample;
